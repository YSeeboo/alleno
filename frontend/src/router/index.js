  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'jewelry-templates', component: () => import('@/views/jewelry-templates/JewelryTemplateList.vue'), meta: { perm: 'parts' } },
        { path: 'jewelry-templates/create', component: () => import('@/views/jewelry-templates/JewelryTemplateCreate.vue'), meta: { perm: 'parts' } },
        { path: 'jewelry-templates/:id', component: () => import('@/views/jewelry-templates/JewelryTemplateDetail.vue'), meta: { perm: 'parts' } },
